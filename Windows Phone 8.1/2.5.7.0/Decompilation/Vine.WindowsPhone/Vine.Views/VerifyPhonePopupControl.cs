...
public sealed class VerifyPhonePopupControl : UserControl, IComponentConnector
{
	...
	public event PopupButtonClickedEventHandler SendSMSClicked;

	public event PopupButtonClickedEventHandler EnterCodeClicked;

	public VerifyPhonePopupControl(string phone)
	{
		InitializeComponent();
		HeaderText.put_Text(string.Format(ResourceHelper.GetString("SettingsVerifyPhoneAlertMessage"), new object[2] { phone, phone }));
	}
	...
	private void ButtonSmsEmail_OnClick(object sender, RoutedEventArgs e)
	{
		if (this.SendSMSClicked != null)
		{
			this.SendSMSClicked(this, new EventArgs());
		}
	}
	...
	public void InitializeComponent()
	{
		...
		{
			_contentLoaded = true;
			Application.LoadComponent((object)this, new Uri("ms-appx:///Views/VerifyPhonePopupControl.xaml"), (ComponentResourceLocation)0);
	...
	public void Connect(int connectionId, object target)
	{
		...
		case 1:
		{
			...
			WindowsRuntimeMarshal.AddEventHandler((Func<RoutedEventHandler, EventRegistrationToken>)val.add_Click, (Action<EventRegistrationToken>)val.remove_Click, new RoutedEventHandler(ButtonSmsEmail_OnClick));
			break;
		}
		case 2:
		{
