...
public sealed class CaptureView10 : BasePage, IComponentConnector
{
	...
	private readonly Rect _previewGridClip;

	private readonly Thickness _captureMargin = new Thickness(0.0, (0.0 - (Window.Current.CoreWindow.Bounds.Height - Window.Current.CoreWindow.Bounds.Width)) / 2.0, 0.0, 0.0);
	...
	public Rect PreviewGridClip => _previewGridClip;

	public Thickness CaptureMargin => _captureMargin;
	...
	public CaptureView10()
	{
		...
		_previewGridClip = new Rect(0.0, 0.0, base.WindowWidth, base.WindowWidth);
	...
	protected override void SaveState(object sender, SaveStateEventArgs e)
	{
		...
		if ((int)e.NavigationEventArgs.NavigationMode == 2 && (object)e.NavigationEventArgs.SourcePageType == typeof(CaptureView10))
		{
	...
	private async Task RecordFromStop()
	{
		...
		try
		{
			...
			CaptureView10 captureView = this;
	...
	private IMediaEncodingProperties GetStreamMediaType(MediaStreamType stream)
	{
		//IL_000b: Unknown result type (might be due to invalid IL or missing references)
		//IL_0028: Unknown result type (might be due to invalid IL or missing references)
		//IL_002e: Expected O, but got Unknown
		IReadOnlyList<IMediaEncodingProperties> availableMediaStreamProperties = MediaCapture.VideoDeviceController.GetAvailableMediaStreamProperties(stream);
		IMediaEncodingProperties result = availableMediaStreamProperties.First();
		foreach (IMediaEncodingProperties item in availableMediaStreamProperties)
		{
			VideoEncodingProperties val = (VideoEncodingProperties)item;
			if (val.Width == 480 && val.Height == 480)
			{
				result = item;
				break;
			}
			if (val.Width == 640 && val.Height == 480)
			{
				result = item;
			}
		}
	...
	private async Task InitializeMediaCapture()
	{
		...
		int num9 = num7 + num3;
		int num10 = num8 + num4;
		_recordVineCapture = new VineCapture((SurfaceImageSource)null, _pausedImageSource, true, false, true, true, false, num, num2, num3, num4, num7, num8, num9, num10);
		...
		IMediaEncodingProperties streamMediaType = GetStreamMediaType((MediaStreamType)1);
		await MediaCapture.VideoDeviceController.SetMediaStreamPropertiesAsync((MediaStreamType)1, streamMediaType);
	...
	public void InitializeComponent()
	{
		...
		{
			_contentLoaded = true;
			Application.LoadComponent((object)this, new Uri("ms-appx:///Views/Capture/CaptureView10.xaml"), (ComponentResourceLocation)0);
