...
public class UnfollowOnTwitterAction extends VineServiceAction {
    @Override // co.vine.android.service.VineServiceAction
    public VineServiceActionResult doAction(VineServiceAction.Request request) {
        Bundle b = request.b;
        long userIdToUnfollow = b.getLong("follow_id");
        b.getBoolean("notify");
        StringBuilder url = VineAPI.buildUponUrl(request.api.getBaseUrl(), "users", Long.valueOf(userIdToUnfollow), "unfollow-on-twitter");
