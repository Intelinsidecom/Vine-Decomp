...
public class WelcomePostCardViewManager extends CardViewManager {
    ...
    private WelcomePostCardViewManager(Builder builder) {
        ...
        this.mHeaderManager = new WelcomePostHeaderViewManager(this.mContext, appController, builder.followActionsLogger);
    ...
    public View newView(int position, View view, ViewGroup viewGroup) {
        if (view == null || !(view.getTag() instanceof WelcomePostCardViewHolder)) {
            ...
            WelcomePostCardViewHolder tag = new WelcomePostCardViewHolder(view);
            view.setTag(tag);
            this.mViewHolders.add(new WeakReference<>(tag));
        }
        WelcomePostCardViewHolder h = (WelcomePostCardViewHolder) view.getTag();
    ...
    public void bind(WelcomePostCardViewHolder h, VinePost data, int position) {
        if (data != null) {
            this.mHeaderManager.bind(h.getHeaderHolder(), data);
            this.mVideoManager.bind(h.getVideoHolder(), data, position);
            this.mFooterManager.bind(h.getFooterHolder(), data);
        }
    }
