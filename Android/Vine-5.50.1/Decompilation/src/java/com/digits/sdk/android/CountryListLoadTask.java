...
class CountryListLoadTask extends AsyncTask<Void, Void, List<CountryInfo>> {
    ...
    public List<CountryInfo> doInBackground(Void... params) {
        List<CountryInfo> countryInfoList = new ArrayList<>(avutil.AV_PIX_FMT_RGBA64BE);
        ...
        countryInfoList.add(new CountryInfo(new Locale("", "AO").getDisplayCountry(), avcodec.AVCodecContext.FF_PROFILE_H264_HIGH_444_PREDICTIVE));
        ...
        countryInfoList.add(new CountryInfo(new Locale("", "AW").getDisplayCountry(), avutil.AV_PIX_FMT_0BGR));
        ...
        countryInfoList.add(new CountryInfo(new Locale("", "CZ").getDisplayCountry(), HttpResponseCode.ENHANCE_YOUR_CLAIM));
        ...
        countryInfoList.add(new CountryInfo(new Locale("", "SV").getDisplayCountry(), HttpResponseCode.SERVICE_UNAVAILABLE));
        countryInfoList.add(new CountryInfo(new Locale("", "GQ").getDisplayCountry(), 240));
        countryInfoList.add(new CountryInfo(new Locale("", "ER").getDisplayCountry(), avutil.AV_PIX_FMT_RGBA64BE));
        ...
        countryInfoList.add(new CountryInfo(new Locale("", "FK").getDisplayCountry(), HttpResponseCode.INTERNAL_SERVER_ERROR));
        countryInfoList.add(new CountryInfo(new Locale("", "FO").getDisplayCountry(), avutil.AV_PIX_FMT_BGR0));
        ...
        countryInfoList.add(new CountryInfo(new Locale("", "GL").getDisplayCountry(), avutil.AV_PIX_FMT_YUVA444P));
        ...
        countryInfoList.add(new CountryInfo(new Locale("", "GT").getDisplayCountry(), HttpResponseCode.BAD_GATEWAY));
        ...
        countryInfoList.add(new CountryInfo(new Locale("", "HN").getDisplayCountry(), HttpResponseCode.GATEWAY_TIMEOUT));
        ...
        countryInfoList.add(new CountryInfo(new Locale("", "GS").getDisplayCountry(), HttpResponseCode.INTERNAL_SERVER_ERROR));
        ...
        countryInfoList.add(new CountryInfo(new Locale("", "ZW").getDisplayCountry(), avutil.AV_CH_LAYOUT_4POINT0));
