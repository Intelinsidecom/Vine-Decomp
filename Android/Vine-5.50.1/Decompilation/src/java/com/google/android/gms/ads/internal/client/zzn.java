...
public interface zzn extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzn {
        ...
        private static class C0012zza implements zzn {
        ...
        public static zzn zzf(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzn)) ? new C0012zza(iBinder) : (zzn) iInterfaceQueryLocalInterface;
        }
