...
public interface zzt extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzt {
        ...
        private static class C0110zza implements zzt {
        ...
        public static zzt zzcP(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzt)) ? new C0110zza(iBinder) : (zzt) iInterfaceQueryLocalInterface;
        }
