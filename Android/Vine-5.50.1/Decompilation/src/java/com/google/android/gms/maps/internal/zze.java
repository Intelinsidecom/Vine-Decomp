...
public interface zze extends IInterface {
    ...
    public static abstract class zza extends Binder implements zze {
        ...
        private static class C0095zza implements zze {
        ...
        public static zze zzcA(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zze)) ? new C0095zza(iBinder) : (zze) iInterfaceQueryLocalInterface;
        }
