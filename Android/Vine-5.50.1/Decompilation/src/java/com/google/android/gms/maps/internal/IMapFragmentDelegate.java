...
public interface IMapFragmentDelegate extends IInterface {
    ...
    public static abstract class zza extends Binder implements IMapFragmentDelegate {
        ...
        private static class C0085zza implements IMapFragmentDelegate {
        ...
        public static IMapFragmentDelegate zzcy(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof IMapFragmentDelegate)) ? new C0085zza(iBinder) : (IMapFragmentDelegate) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                ...
                case 12:
                    data.enforceInterface("com.google.android.gms.maps.internal.IMapFragmentDelegate");
                    getMapAsync(zzl.zza.zzcH(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 13:
                    data.enforceInterface("com.google.android.gms.maps.internal.IMapFragmentDelegate");
