...
final class H262Reader extends ElementaryStreamReader {
    ...
    public void consume(ParsableByteArray data) {
        if (data.bytesLeft() > 0) {
            ...
            while (true) {
                ...
                int startCodeValue = data.data[startCodeOffset + 3] & Constants.UNKNOWN;
    ...
    private static Pair<MediaFormat, Long> parseCsdBuffer(CsdBuffer csdBuffer) {
        ...
        int firstByte = csdData[4] & Constants.UNKNOWN;
        int secondByte = csdData[5] & Constants.UNKNOWN;
        int thirdByte = csdData[6] & Constants.UNKNOWN;
        ...
        MediaFormat format = MediaFormat.createVideoFormat(null, "video/mpeg2", -1, -1, -1L, width, height, Collections.singletonList(csdData), -1, pixelWidthHeightRatio);
