...
public interface IPolylineDelegate extends IInterface {
    ...
    public static abstract class zza extends Binder implements IPolylineDelegate {
        ...
        private static class C0114zza implements IPolylineDelegate {
        ...
        public static IPolylineDelegate zzdf(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof IPolylineDelegate)) ? new C0114zza(iBinder) : (IPolylineDelegate) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                ...
                case 15:
                    parcel.enforceInterface("com.google.android.gms.maps.model.internal.IPolylineDelegate");
                    boolean zEqualsRemote = equalsRemote(zzdf(parcel.readStrongBinder()));
                    parcel2.writeNoException();
