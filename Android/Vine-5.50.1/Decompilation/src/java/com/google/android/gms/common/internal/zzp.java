...
public interface zzp extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzp {
        ...
        private static class C0035zza implements zzp {
        ...
        public static zzp zzaP(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzp)) ? new C0035zza(iBinder) : (zzp) iInterfaceQueryLocalInterface;
        }
