...
public class zzs {
    ...
    static class zza {
        ...
        private final List<C0081zza> zzal = new ArrayList();
        ...
        private static class C0081zza {
            public final String name;
            public final long time;
            public final long zzan;

            public C0081zza(String str, long j, long j2) {
                this.name = str;
                this.zzan = j;
                this.time = j2;
            }
        ...
        public synchronized void zza(String str, long j) {
            ...
            this.zzal.add(new C0081zza(str, j, SystemClock.elapsedRealtime()));
        }
        ...
        public synchronized void zzd(String str) {
            ...
            if (jZzx > 0) {
                ...
                long j2 = j;
                for (C0081zza c0081zza : this.zzal) {
                    long j3 = c0081zza.time;
                    zzs.zzb("(+%-4d) [%2d] %s", Long.valueOf(j3 - j2), Long.valueOf(c0081zza.zzan), c0081zza.name);
                    j2 = j3;
                }
            }
        }
