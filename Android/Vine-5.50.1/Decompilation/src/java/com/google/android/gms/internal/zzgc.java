...
public interface zzgc extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzgc {
        ...
        private static class C0073zza implements zzgc {
        ...
        public static zzgc zzP(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzgc)) ? new C0073zza(iBinder) : (zzgc) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    ...
                    zza(zzgb.zza.zzO(data.readStrongBinder()));
    ...
    void zza(zzgb zzgbVar) throws RemoteException;
}
