...
public class DefaultScribeClient extends ScribeClient {
    ...
    public void scribe(EventNamespace namespace, List<Object> list) {
        String language;
        ...
        scribe(ScribeEventFactory.newScribeEvent(namespace, timestamp, language, this.advertisingId, list));
    }
    ...
    static ScribeConfig getScribeConfig(SettingsData settingsData, String userAgent) {
        ...
        String scribeUrl = getScribeUrl("https://syndication.twitter.com", "");
        return new ScribeConfig(isEnabled(), scribeUrl, "i", "sdk", "", userAgent, maxFilesToKeep, sendIntervalSeconds);
    }

    private static boolean isEnabled() {
        return !BuildConfig.BUILD_TYPE.equals(PropertyConfiguration.DEBUG);
    }
