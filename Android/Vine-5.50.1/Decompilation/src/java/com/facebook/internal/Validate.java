...
public final class Validate {
    ...
    public static void hasFacebookActivity(Context context) throws PackageManager.NameNotFoundException {
        hasFacebookActivity(context, true);
    }

    public static void hasFacebookActivity(Context context, boolean shouldThrow) throws PackageManager.NameNotFoundException {
        notNull(context, "context");
    ...
    public static void hasContentProvider(Context context) {
        ...
        PackageManager pm = context.getPackageManager();
        if (pm != null) {
            String providerName = "com.facebook.app.FacebookContentProvider" + appId;
            if (pm.resolveContentProvider(providerName, 0) == null) {
                throw new IllegalStateException(String.format("A ContentProvider for this app was not set up in the AndroidManifest.xml, please add %s as a provider to your AndroidManifest.xml file. See https://developers.facebook.com/docs/sharing/android for more info.", providerName));
            }
        }
    }
}
