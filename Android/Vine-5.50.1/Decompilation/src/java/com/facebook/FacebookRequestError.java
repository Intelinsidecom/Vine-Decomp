...
public final class FacebookRequestError {
    static final Range HTTP_RANGE_SUCCESS = new Range(HttpResponseCode.OK, avutil.AV_PIX_FMT_YUVA444P);
    ...
    static FacebookRequestError checkResponseAndCreateError(JSONObject singleResult, Object batchResult, HttpURLConnection connection) throws JSONException {
        try {
            if (singleResult.has("code")) {
                ...
                if (!HTTP_RANGE_SUCCESS.contains(responseCode)) {
                    return new FacebookRequestError(responseCode, -1, -1, null, null, null, null, false, singleResult.has("body") ? (JSONObject) Utility.getStringPropertyAsJSON(singleResult, "body", "FACEBOOK_NON_JSON_RESULT") : null, singleResult, batchResult, connection, null);
                }
            }
