...
public class FileTypeBox extends AbstractBox {
    ...
    private static /* synthetic */ void ajc$preClinit() {
        ...
        ajc$tjp_3 = factory.makeSJP("method-execution", factory.makeMethodSig("1", "getMinorVersion", "com.coremedia.iso.boxes.FileTypeBox", "", "", "", "long"), avcodec.AV_CODEC_ID_INDEO5);
    ...
    public void setMinorVersion(int minorVersion) {
        RequiresParseDetailAspect.aspectOf().before(Factory.makeJP(ajc$tjp_2, this, this, Conversions.intObject(minorVersion)));
        this.minorVersion = minorVersion;
    }
