...
public class TrackHeaderBox extends AbstractFullBox {
    ...
    private static /* synthetic */ void ajc$preClinit() {
        ...
        ajc$tjp_10 = factory.makeSJP("method-execution", factory.makeMethodSig("1", "getContent", "com.coremedia.iso.boxes.TrackHeaderBox", "java.nio.ByteBuffer", "byteBuffer", "", "void"), avcodec.AV_CODEC_ID_PICTOR);
        ajc$tjp_11 = factory.makeSJP("method-execution", factory.makeMethodSig("1", "toString", "com.coremedia.iso.boxes.TrackHeaderBox", "", "", "", "java.lang.String"), avcodec.AV_CODEC_ID_AIC);
        ...
        ajc$tjp_25 = factory.makeSJP("method-execution", factory.makeMethodSig("1", "isInPoster", "com.coremedia.iso.boxes.TrackHeaderBox", "", "", "", "boolean"), avutil.AV_CH_LAYOUT_2_1);
        ajc$tjp_26 = factory.makeSJP("method-execution", factory.makeMethodSig("1", "setEnabled", "com.coremedia.iso.boxes.TrackHeaderBox", "boolean", "enabled", "", "void"), avutil.AV_CH_LAYOUT_4POINT0);
        ajc$tjp_27 = factory.makeSJP("method-execution", factory.makeMethodSig("1", "setInMovie", "com.coremedia.iso.boxes.TrackHeaderBox", "boolean", "inMovie", "", "void"), avutil.AV_CH_LAYOUT_4POINT1);
    ...
    public void setCreationTime(Date creationTime) {
        ...
        if (DateHelper.convert(creationTime) >= avutil.AV_CH_WIDE_RIGHT) {
            setVersion(1);
        }
    }
    ...
    public void setModificationTime(Date modificationTime) {
        ...
        if (DateHelper.convert(modificationTime) >= avutil.AV_CH_WIDE_RIGHT) {
            setVersion(1);
        }
    }
    ...
    public void setDuration(long duration) {
        ...
        if (duration >= avutil.AV_CH_WIDE_RIGHT) {
            setFlags(1);
        }
    }
