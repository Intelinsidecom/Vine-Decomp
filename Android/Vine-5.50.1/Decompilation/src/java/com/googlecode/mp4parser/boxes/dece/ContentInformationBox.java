...
public class ContentInformationBox extends AbstractFullBox {
    ...
    private static /* synthetic */ void ajc$preClinit() {
        ...
        ajc$tjp_1 = factory.makeSJP("method-execution", factory.makeMethodSig("1", "setMimeSubtypeName", "com.googlecode.mp4parser.boxes.dece.ContentInformationBox", "java.lang.String", "mimeSubtypeName", "", "void"), avcodec.AV_CODEC_ID_LAGARITH);
        ...
        ajc$tjp_2 = factory.makeSJP("method-execution", factory.makeMethodSig("1", "getProfileLevelIdc", "com.googlecode.mp4parser.boxes.dece.ContentInformationBox", "", "", "", "java.lang.String"), avcodec.AV_CODEC_ID_WMV3IMAGE);
        ajc$tjp_3 = factory.makeSJP("method-execution", factory.makeMethodSig("1", "setProfileLevelIdc", "com.googlecode.mp4parser.boxes.dece.ContentInformationBox", "java.lang.String", "profileLevelIdc", "", "void"), avcodec.AV_CODEC_ID_VBLE);
        ajc$tjp_4 = factory.makeSJP("method-execution", factory.makeMethodSig("1", "getCodecs", "com.googlecode.mp4parser.boxes.dece.ContentInformationBox", "", "", "", "java.lang.String"), avcodec.AV_CODEC_ID_CDXL);
        ajc$tjp_5 = factory.makeSJP("method-execution", factory.makeMethodSig("1", "setCodecs", "com.googlecode.mp4parser.boxes.dece.ContentInformationBox", "java.lang.String", "codecs", "", "void"), avcodec.AV_CODEC_ID_MSA1);
        ajc$tjp_6 = factory.makeSJP("method-execution", factory.makeMethodSig("1", "getProtection", "com.googlecode.mp4parser.boxes.dece.ContentInformationBox", "", "", "", "java.lang.String"), avcodec.AV_CODEC_ID_MSS2);
        ajc$tjp_7 = factory.makeSJP("method-execution", factory.makeMethodSig("1", "setProtection", "com.googlecode.mp4parser.boxes.dece.ContentInformationBox", "java.lang.String", "protection", "", "void"), avcodec.AV_CODEC_ID_G2M_DEPRECATED);
