...
public class SegmentIndexBox extends AbstractFullBox {
    ...
    private static /* synthetic */ void ajc$preClinit() {
        ...
        ajc$tjp_10 = factory.makeSJP("method-execution", factory.makeMethodSig("1", "getReserved", "com.googlecode.mp4parser.boxes.threegpp26244.SegmentIndexBox", "", "", "", "int"), avcodec.AV_CODEC_ID_MSS2);
        ajc$tjp_11 = factory.makeSJP("method-execution", factory.makeMethodSig("1", "setReserved", "com.googlecode.mp4parser.boxes.threegpp26244.SegmentIndexBox", "int", "reserved", "", "void"), avcodec.AV_CODEC_ID_G2M_DEPRECATED);
        ajc$tjp_12 = factory.makeSJP("method-execution", factory.makeMethodSig("1", "toString", "com.googlecode.mp4parser.boxes.threegpp26244.SegmentIndexBox", "", "", "", "java.lang.String"), avutil.AV_PIX_FMT_BGR0);
        ajc$tjp_2 = factory.makeSJP("method-execution", factory.makeMethodSig("1", "getReferenceId", "com.googlecode.mp4parser.boxes.threegpp26244.SegmentIndexBox", "", "", "", "long"), avcodec.AV_CODEC_ID_BINKVIDEO);
        ajc$tjp_3 = factory.makeSJP("method-execution", factory.makeMethodSig("1", "setReferenceId", "com.googlecode.mp4parser.boxes.threegpp26244.SegmentIndexBox", "long", "referenceId", "", "void"), avcodec.AV_CODEC_ID_YOP);
        ...
        ajc$tjp_5 = factory.makeSJP("method-execution", factory.makeMethodSig("1", "setTimeScale", "com.googlecode.mp4parser.boxes.threegpp26244.SegmentIndexBox", "long", "timeScale", "", "void"), avcodec.AV_CODEC_ID_LAGARITH);
        ajc$tjp_6 = factory.makeSJP("method-execution", factory.makeMethodSig("1", "getEarliestPresentationTime", "com.googlecode.mp4parser.boxes.threegpp26244.SegmentIndexBox", "", "", "", "long"), avcodec.AV_CODEC_ID_WMV3IMAGE);
        ajc$tjp_7 = factory.makeSJP("method-execution", factory.makeMethodSig("1", "setEarliestPresentationTime", "com.googlecode.mp4parser.boxes.threegpp26244.SegmentIndexBox", "long", "earliestPresentationTime", "", "void"), avcodec.AV_CODEC_ID_VBLE);
        ajc$tjp_8 = factory.makeSJP("method-execution", factory.makeMethodSig("1", "getFirstOffset", "com.googlecode.mp4parser.boxes.threegpp26244.SegmentIndexBox", "", "", "", "long"), avcodec.AV_CODEC_ID_CDXL);
        ajc$tjp_9 = factory.makeSJP("method-execution", factory.makeMethodSig("1", "setFirstOffset", "com.googlecode.mp4parser.boxes.threegpp26244.SegmentIndexBox", "long", "firstOffset", "", "void"), avcodec.AV_CODEC_ID_MSA1);
    }
