...
public class TimeCodeBox extends AbstractBox implements SampleEntry {
    ...
    private static /* synthetic */ void ajc$preClinit() {
        ...
        ajc$tjp_12 = factory.makeSJP("method-execution", factory.makeMethodSig("1", "setReserved2", "com.googlecode.mp4parser.boxes.apple.TimeCodeBox", "int", "reserved2", "", "void"), avcodec.AV_CODEC_ID_IFF_BYTERUN1);
        ajc$tjp_13 = factory.makeSJP("method-execution", factory.makeMethodSig("1", "getFlags", "com.googlecode.mp4parser.boxes.apple.TimeCodeBox", "", "", "", "long"), avcodec.AV_CODEC_ID_PICTOR);
        ajc$tjp_14 = factory.makeSJP("method-execution", factory.makeMethodSig("1", "setFlags", "com.googlecode.mp4parser.boxes.apple.TimeCodeBox", "long", "flags", "", "void"), avcodec.AV_CODEC_ID_R10K);
        ajc$tjp_15 = factory.makeSJP("method-execution", factory.makeMethodSig("1", "getRest", "com.googlecode.mp4parser.boxes.apple.TimeCodeBox", "", "", "", "[B"), avcodec.AV_CODEC_ID_JV);
        ajc$tjp_16 = factory.makeSJP("method-execution", factory.makeMethodSig("1", "setRest", "com.googlecode.mp4parser.boxes.apple.TimeCodeBox", "[B", "rest", "", "void"), avcodec.AV_CODEC_ID_UTVIDEO);
        ...
        ajc$tjp_6 = factory.makeSJP("method-execution", factory.makeMethodSig("1", "setFrameDuration", "com.googlecode.mp4parser.boxes.apple.TimeCodeBox", "int", "frameDuration", "", "void"), avcodec.AV_CODEC_ID_MIMIC);
