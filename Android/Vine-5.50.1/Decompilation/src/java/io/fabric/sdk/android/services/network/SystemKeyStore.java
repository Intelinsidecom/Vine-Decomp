...
class SystemKeyStore {
    ...
    public SystemKeyStore(InputStream keystoreStream, String passwd) throws IOException, KeyStoreException {
    ...
    private KeyStore getTrustStore(InputStream keystoreStream, String passwd) throws IOException, KeyStoreException {
        try {
