...
public final class HttpParameter implements Serializable, Comparable {
    ...
    public String getContentType() {
        ...
        if (extensions2.length() == 4 && "jpeg".equals(extensions2)) {
            return JPEG;
        }
        return OCTET;
    }
    ...
    public int hashCode() {
        ...
        return (((((result * 31) + (this.value != null ? this.value.hashCode() : 0)) * 31) + (this.file != null ? this.file.hashCode() : 0)) * 31) + (this.fileBody != null ? this.fileBody.hashCode() : 0);
    }
