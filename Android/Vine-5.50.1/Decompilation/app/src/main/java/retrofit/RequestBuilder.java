...
final class RequestBuilder implements RequestInterceptor.RequestFacade {
    ...
    @Override // retrofit.RequestInterceptor.RequestFacade
    public void addPathParam(String name, String value) throws UnsupportedEncodingException {
        addPathParam(name, value, true);
    }

    @Override // retrofit.RequestInterceptor.RequestFacade
    public void addEncodedPathParam(String name, String value) throws UnsupportedEncodingException {
        addPathParam(name, value, false);
    }

    private void addPathParam(String name, String value, boolean urlEncodeValue) throws UnsupportedEncodingException {
        if (name == null) {
    ...
    @Override // retrofit.RequestInterceptor.RequestFacade
    public void addQueryParam(String name, String value) throws UnsupportedEncodingException {
        addQueryParam(name, value, false, true);
    }

    @Override // retrofit.RequestInterceptor.RequestFacade
    public void addEncodedQueryParam(String name, String value) throws UnsupportedEncodingException {
        addQueryParam(name, value, false, false);
    }

    private void addQueryParam(String name, Object value, boolean encodeName, boolean encodeValue) throws ArrayIndexOutOfBoundsException, IllegalArgumentException, UnsupportedEncodingException {
    ...
    private void addQueryParam(String name, String value, boolean encodeName, boolean encodeValue) throws UnsupportedEncodingException {
        if (name == null) {
    ...
    private void addQueryParamMap(int parameterNumber, Map<?, ?> map, boolean encodeNames, boolean encodeValues) throws UnsupportedEncodingException {
    ...
    void setArguments(Object[] args) throws ArrayIndexOutOfBoundsException, IllegalArgumentException, UnsupportedEncodingException {
        if (args != null) {
