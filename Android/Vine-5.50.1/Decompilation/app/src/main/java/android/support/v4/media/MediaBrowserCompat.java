...
public final class MediaBrowserCompat {
    ...
    public static abstract class SubscriptionCallback {
        ...
        private class StubApi21 implements MediaBrowserCompatApi21.SubscriptionCallback {
            ...
            public void onChildrenLoaded(String parentId, List<Parcel> children) {
        ...
        private class StubApi24 extends StubApi21 implements MediaBrowserCompatApi24.SubscriptionCallback {
            ...
            public void onChildrenLoaded(String parentId, List<Parcel> children, Bundle options) {
    ...
    static class MediaBrowserImplBase implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
        ...
        @Override // android.support.v4.media.MediaBrowserCompat.MediaBrowserImpl
        public void subscribe(String parentId, Bundle options, SubscriptionCallback callback) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        ...
        @Override // android.support.v4.media.MediaBrowserCompat.MediaBrowserImpl
        public void unsubscribe(String parentId, SubscriptionCallback callback) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
            Subscription sub = this.mSubscriptions.get(parentId);
            if (sub != null) {
                try {
                    if (callback == null) {
