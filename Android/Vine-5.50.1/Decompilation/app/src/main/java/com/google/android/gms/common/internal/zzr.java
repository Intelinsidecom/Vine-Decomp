...
public interface zzr extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzr {
        ...
        private static class C0036zza implements zzr {
        ...
        public static zzr zzaR(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzr)) ? new C0036zza(iBinder) : (zzr) iInterfaceQueryLocalInterface;
        }
