...
public class ShareContentValidation {
    ...
    public static void validateForMessage(ShareContent content) throws FacebookException {
        validate(content, getDefaultValidator());
    }

    public static void validateForNativeShare(ShareContent content) throws FacebookException {
        validate(content, getDefaultValidator());
    }

    public static void validateForWebShare(ShareContent content) throws FacebookException {
