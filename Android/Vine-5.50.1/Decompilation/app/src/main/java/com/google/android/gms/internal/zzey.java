...
public interface zzey extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzey {
        ...
        private static class C0065zza implements zzey {
            ...
            @Override // com.google.android.gms.internal.zzey
            public void zza(zzez zzezVar) throws RemoteException {
                Parcel parcelObtain = Parcel.obtain();
                Parcel parcelObtain2 = Parcel.obtain();
                try {
                    parcelObtain.writeInterfaceToken("com.google.android.gms.ads.internal.mediation.client.IMediationAdapterListener");
        ...
        public static zzey zzG(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzey)) ? new C0065zza(iBinder) : (zzey) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                ...
                case 7:
                    data.enforceInterface("com.google.android.gms.ads.internal.mediation.client.IMediationAdapterListener");
                    zza(zzez.zza.zzH(data.readStrongBinder()));
                    reply.writeNoException();
                    return true;
                case 1598968902:
