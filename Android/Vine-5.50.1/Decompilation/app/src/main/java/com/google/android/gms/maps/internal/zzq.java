...
public interface zzq extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzq {
        ...
        private static class C0107zza implements zzq {
        ...
        public static zzq zzcM(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzq)) ? new C0107zza(iBinder) : (zzq) iInterfaceQueryLocalInterface;
        }
