...
public interface zzh extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzh {
        ...
        private static class C0122zza implements zzh {
        ...
        public static zzh zzdg(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzh)) ? new C0122zza(iBinder) : (zzh) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                ...
                case 8:
                    parcel.enforceInterface("com.google.android.gms.maps.model.internal.ITileOverlayDelegate");
                    boolean zZza = zza(zzdg(parcel.readStrongBinder()));
                    parcel2.writeNoException();
