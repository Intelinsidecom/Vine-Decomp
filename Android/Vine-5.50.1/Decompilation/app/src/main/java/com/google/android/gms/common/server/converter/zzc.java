...
public class zzc implements Parcelable.Creator<StringToIntConverter.Entry> {
    static void zza(StringToIntConverter.Entry entry, Parcel parcel, int i) {
        ...
        com.google.android.gms.common.internal.safeparcel.zzb.zza(parcel, 2, entry.zzakS, false);
        com.google.android.gms.common.internal.safeparcel.zzb.zzc(parcel, 3, entry.zzakT);
