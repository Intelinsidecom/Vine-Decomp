...
class PhoneNumberActivityDelegate extends DigitsActivityDelegateImpl implements PhoneNumberTask.Listener, TosView {
    ...
    PhoneNumberController initController(Bundle bundle) {
        return new PhoneNumberController((ResultReceiver) bundle.getParcelable("receiver"), this.sendButton, this.phoneEditText, this.countryCodeSpinner, this, this.scribeService, bundle.getBoolean("email_enabled"));
    }
