...
public class AbstractContainerBox extends BasicContainer implements Box {
    ...
    public long getSize() {
        ...
        return ((this.largeBox || 8 + s >= avutil.AV_CH_WIDE_RIGHT) ? 16 : 8) + s;
    }
    ...
    protected ByteBuffer getHeader() {
        ByteBuffer header;
        if (this.largeBox || getSize() >= avutil.AV_CH_WIDE_RIGHT) {
    ...
    public void initContainer(DataSource dataSource, long containerSize, BoxParser boxParser) throws IOException {
        ...
        this.startPosition = this.parsePosition - ((this.largeBox || 8 + containerSize >= avutil.AV_CH_WIDE_RIGHT) ? 16 : 8);
