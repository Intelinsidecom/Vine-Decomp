...
public class LoginButton extends FacebookButtonBase {
    ...
    private void checkToolTipSettings() throws Resources.NotFoundException {
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) throws Resources.NotFoundException {
    ...
    protected void configureButton(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) throws Resources.NotFoundException {
        ...
        if (isInEditMode()) {
            ...
            this.accessTokenTracker = new AccessTokenTracker() { // from class: com.facebook.login.widget.LoginButton.2
                ...
                protected void onCurrentAccessTokenChanged(AccessToken oldAccessToken, AccessToken currentAccessToken) throws Resources.NotFoundException {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void setButtonText() throws Resources.NotFoundException {
        Resources resources = getResources();
    ...
    private class LoginClickListener implements View.OnClickListener {
        ...
        public void onClick(View v) throws Resources.NotFoundException, FacebookException {
            String message;
