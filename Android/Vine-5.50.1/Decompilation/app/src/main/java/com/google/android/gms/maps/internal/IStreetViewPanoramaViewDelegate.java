...
public interface IStreetViewPanoramaViewDelegate extends IInterface {
    ...
    public static abstract class zza extends Binder implements IStreetViewPanoramaViewDelegate {
        ...
        private static class C0090zza implements IStreetViewPanoramaViewDelegate {
        ...
        public static IStreetViewPanoramaViewDelegate zzcW(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof IStreetViewPanoramaViewDelegate)) ? new C0090zza(iBinder) : (IStreetViewPanoramaViewDelegate) iInterfaceQueryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            switch (i) {
                ...
                case 9:
                    parcel.enforceInterface("com.google.android.gms.maps.internal.IStreetViewPanoramaViewDelegate");
                    getStreetViewPanoramaAsync(zzv.zza.zzcR(parcel.readStrongBinder()));
                    parcel2.writeNoException();
                    return true;
                case 1598968902:
