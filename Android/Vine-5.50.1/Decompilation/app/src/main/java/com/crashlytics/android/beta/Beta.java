...
public class Beta extends Kit<Boolean> implements DeviceIdentifierProvider {
    ...
    private String getBetaDeviceToken(Context context, String installerPackageName) {
        if (isAppPossiblyInstalledByBeta(installerPackageName, Build.VERSION.SDK_INT)) {
    ...
    private BuildProperties loadBuildProperties(Context context) throws IOException {
