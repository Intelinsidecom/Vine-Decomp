...
public interface zzu extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzu {
        ...
        private static class C0111zza implements zzu {
        ...
        public static zzu zzcQ(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzu)) ? new C0111zza(iBinder) : (zzu) iInterfaceQueryLocalInterface;
        }
