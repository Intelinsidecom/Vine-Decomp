...
public interface zzav extends IInterface {
    ...
    public static abstract class zza extends Binder implements zzav {
        ...
        private static class C0044zza implements zzav {
        ...
        public static zzav zzb(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof zzav)) ? new C0044zza(iBinder) : (zzav) iInterfaceQueryLocalInterface;
        }
