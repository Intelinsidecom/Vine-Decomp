...
public class ResubscribeActionNotifier implements ListenerNotifier {
    private final ArrayList<UserInteractionsListener> mListeners;

    public ResubscribeActionNotifier(ArrayList<UserInteractionsListener> listeners) {
    ...
    public void notifyListeners(ServiceNotification notification) {
        ...
        while (it.hasNext()) {
            ...
            listener.onResubscribeComplete(notification.reqId, notification.statusCode, notification.reasonPhrase, userId);
        }
    }
}
