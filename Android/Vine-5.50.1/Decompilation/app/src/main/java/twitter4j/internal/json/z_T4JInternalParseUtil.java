...
public final class z_T4JInternalParseUtil {
    ...
    public static Date parseTrendsDate(String asOfStr) throws InterruptedException, TwitterException {
        switch (asOfStr.length()) {
            case 10:
                Date parsed = new Date(Long.parseLong(asOfStr) * 1000);
                return parsed;
            case 20:
                Date parsed2 = getDate(asOfStr, "yyyy-MM-dd'T'HH:mm:ss'Z'");
                return parsed2;
            default:
                Date parsed3 = getDate(asOfStr, "EEE, d MMM yyyy HH:mm:ss z");
                return parsed3;
        }
    }
    ...
    public static Date getDate(String dateString, String format) throws InterruptedException, TwitterException {
