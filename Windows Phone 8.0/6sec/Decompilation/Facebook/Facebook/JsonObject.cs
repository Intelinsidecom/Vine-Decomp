...
public class JsonObject : DynamicObject, IDictionary<string, object>, ICollection<KeyValuePair<string, object>>, IEnumerable<KeyValuePair<string, object>>, IEnumerable
{
	...
	public override bool TryConvert(ConvertBinder binder, out object result)
	{
		...
		if ((object)type == typeof(IEnumerable) || (object)type == typeof(IEnumerable<KeyValuePair<string, object>>) || (object)type == typeof(IDictionary<string, object>) || (object)type == typeof(IDictionary))
		{
			result = this;
			return true;
		}
